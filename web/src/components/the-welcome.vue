          ...
          <a-row>
            ...
            <a-col :span="8">
              <a-statistic title="点赞率"
                           :value="statistic.viewCount != 0? (statistic.voteCount / statistic.viewCount) * 100:0"
                           :precision="2"
                           suffix="%"
    ...
    const getStatistic = () => {
      axios.get('/ebook-snapshot/get-statistic').then((response) => {
        ...
        if (data.success) {
          ...
          statistic.value.todayViewIncreaseRate = statisticResp[0].viewIncrease != 0 ? ((statistic.value.todayViewIncrease - statisticResp[0].viewIncrease) / statisticResp[0].viewIncrease * 100) : 0;
